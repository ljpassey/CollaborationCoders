  ...
  return (
    <html lang="en">
      ...
      <body>
        <main>
          <Nav />
          <div className=" w-full fixed opacity-25  -z-30">
            <svg
