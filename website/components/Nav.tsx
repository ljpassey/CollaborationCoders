            ...
            {navigation.map((menu, index) => (
              <li className="mr-3 nav__item" key={index}>
                <Link
                  ...
                  className="inline-block px-4 py-2 text-lg font-normal bg-white bg-opacity-20 text-gray-800 no-underline rounded-md dark:text-gray-200 hover:text-orange-600 focus:text-orange-600 focus:bg-orange-100 focus:outline-none dark:focus:bg-gray-800"
                >
                  {menu}
                </Link>
              </li>
