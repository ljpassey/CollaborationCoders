        ...
        <div className="  lg:w-1/2">
          <div className="flex flex-wrap">
            ...
            <p className="py-5 text-xl leading-normal text-gray-300 lg:text-xl xl:text-2xl dark:text-gray-300">
              ...
              combines technical expertise with creativity, harnessing the power
              of AI to drive innovation and deliver exceptional value to our
              clients.
            </p>
            ...
            <div className="flex flex-col items-start space-y-3 sm:space-x-4 sm:space-y-0 sm:items-center sm:flex-row">
              <Link
                href="/blog"
                className="px-8 py-4 text-lg font-medium text-center text-white bg-orange-600 hover:bg-orange-700 transition-all ease-in rounded-md "
              >
                Explore our blog
              </Link>
              <Link
